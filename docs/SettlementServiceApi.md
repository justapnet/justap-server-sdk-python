 ...
 **recipient_wechatpay_channel_recipient_app_id** | **str**| 微信支付分账接收方 openid 所对应的服务商公众号 ID | [optional] 
 **recipient_wechatpay_channel_recipient_sub_app_id** | **str**| 微信支付分账接收方 openid 所对应的商户公众号 ID | [optional] 
 ...
 **data_recipient_wechatpay_channel_recipient_app_id** | **str**| 微信支付分账接收方 openid 所对应的服务商公众号 ID | [optional] 
 **data_recipient_wechatpay_channel_recipient_sub_app_id** | **str**| 微信支付分账接收方 openid 所对应的商户公众号 ID | [optional] 
