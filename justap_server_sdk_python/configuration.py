...
class Configuration(object):
    ...
    def __init__(self):
        ...
        # Default Base url
        self.host = "http://127.0.0.1:21011"
        ...
        # Logging Settings
        self.logger = {}
        self.logger["package_logger"] = logging.getLogger("justap_server_sdk_python")
            ...
            'ApiKeyAuth':
                {
                    'type': 'api_key',
                    'in': 'header',
                    'key': 'X-JUSTAP-API-KEY',
                    'value': self.get_api_key_with_prefix('X-JUSTAP-API-KEY')
                },
