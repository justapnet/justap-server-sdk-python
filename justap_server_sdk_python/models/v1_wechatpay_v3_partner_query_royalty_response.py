...
class V1WechatpayV3PartnerQueryRoyaltyResponse(object):
    ...
    def __init__(self, _configuration=None):  # noqa: E501
        """V1WechatpayV3PartnerQueryRoyaltyResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1WechatpayV3PartnerQueryRoyaltyResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1WechatpayV3PartnerQueryRoyaltyResponse):
            return False
