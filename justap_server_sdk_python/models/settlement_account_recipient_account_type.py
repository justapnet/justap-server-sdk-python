...
class SettlementAccountRecipientAccountType(object):
    ...
    allowed enum values
    """
    ACCOUNT_TYPE_UNSET = "ACCOUNT_TYPE_UNSET"
    ...
    def __init__(self, _configuration=None):  # noqa: E501
        """SettlementAccountRecipientAccountType - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SettlementAccountRecipientAccountType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SettlementAccountRecipientAccountType):
            return False
