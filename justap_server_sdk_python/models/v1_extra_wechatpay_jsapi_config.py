...
class V1ExtraWechatpayJsapiConfig(object):
    ...
    def __init__(self, app_id=None, nonce_str=None, package=None, pay_sign=None, sign_type=None, time_stamp=None, _configuration=None):  # noqa: E501
        """V1ExtraWechatpayJsapiConfig - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1ExtraWechatpayJsapiConfig, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1ExtraWechatpayJsapiConfig):
            return False
