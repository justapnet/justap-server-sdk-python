...
class CreateRoyaltyRequestRoyaltyMode(object):
    ...
    allowed enum values
    """
    ROYALTY_MODE_UNSET = "ROYALTY_MODE_UNSET"
    FIXED = "FIXED"
    RATE = "RATE"
    ...
    def __init__(self, _configuration=None):  # noqa: E501
        """CreateRoyaltyRequestRoyaltyMode - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreateRoyaltyRequestRoyaltyMode, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateRoyaltyRequestRoyaltyMode):
            return False
