...
class V1ExtraAlipayRoyaltyInfo(object):
    ...
    """
    swagger_types = {
        'royalty_detail_infos': 'ExtraAlipayRoyaltyInfoRoyaltyDetailInfos',
        'royalty_type': 'str'
    }

    attribute_map = {
        'royalty_detail_infos': 'royalty_detail_infos',
        'royalty_type': 'royalty_type'
    }

    def __init__(self, royalty_detail_infos=None, royalty_type=None, _configuration=None):  # noqa: E501
        """V1ExtraAlipayRoyaltyInfo - a model defined in Swagger"""  # noqa: E501
    ...
    def royalty_detail_infos(self, royalty_detail_infos):
        ...
        self._royalty_detail_infos = royalty_detail_infos
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1ExtraAlipayRoyaltyInfo, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1ExtraAlipayRoyaltyInfo):
            return False
