...
class Tradev1RoyaltyMethod(object):
    ...
    allowed enum values
    """
    ROYALTYMETHODUNSET = "RoyaltyMethodUnset"
    BALANCE = "Balance"
    ALIPAY = "Alipay"
    WECHATPAY = "Wechatpay"
    YSEPAYMERCHANT = "YsepayMerchant"
    ...
    def __init__(self, _configuration=None):  # noqa: E501
        """Tradev1RoyaltyMethod - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(Tradev1RoyaltyMethod, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Tradev1RoyaltyMethod):
            return False
