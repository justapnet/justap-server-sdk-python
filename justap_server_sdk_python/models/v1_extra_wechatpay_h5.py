...
class V1ExtraWechatpayH5(object):
    ...
    def __init__(self, attach=None, detail=None, goods_tag=None, pay_sign=None, pay_url=None, prepay_id=None, scene_info=None, settle_info=None, time_expire=None, time_start=None, wap_name=None, wap_url=None, _configuration=None):  # noqa: E501
        """V1ExtraWechatpayH5 - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1ExtraWechatpayH5, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1ExtraWechatpayH5):
            return False
