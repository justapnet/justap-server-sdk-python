...
class V1RoyaltyRoutingRequestRoyaltyMethod(object):
    ...
    allowed enum values
    """
    ROYALTY_METHOD_UNKNOWN = "ROYALTY_METHOD_UNKNOWN"
    CREATE_ROYALTY = "CREATE_ROYALTY"
    ...
    def __init__(self, _configuration=None):  # noqa: E501
        """V1RoyaltyRoutingRequestRoyaltyMethod - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1RoyaltyRoutingRequestRoyaltyMethod, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1RoyaltyRoutingRequestRoyaltyMethod):
            return False
