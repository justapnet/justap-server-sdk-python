...
class V1ExtraAlipaySubMerchant(object):
    ...
    def __init__(self, merchant_id=None, merchant_type=None, _configuration=None):  # noqa: E501
        """V1ExtraAlipaySubMerchant - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1ExtraAlipaySubMerchant, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1ExtraAlipaySubMerchant):
            return False
