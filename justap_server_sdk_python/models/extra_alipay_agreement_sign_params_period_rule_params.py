...
class ExtraAlipayAgreementSignParamsPeriodRuleParams(object):
    ...
    def __init__(self, execute_time=None, period=None, period_type=None, single_amount=None, total_amount=None, total_payments=None, _configuration=None):  # noqa: E501
        """ExtraAlipayAgreementSignParamsPeriodRuleParams - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ExtraAlipayAgreementSignParamsPeriodRuleParams, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExtraAlipayAgreementSignParamsPeriodRuleParams):
            return False
