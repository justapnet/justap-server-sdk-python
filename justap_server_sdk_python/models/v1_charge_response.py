...
class V1ChargeResponse(object):
    ...
    def __init__(self, data=None, object='Charge', _configuration=None):  # noqa: E501
        """V1ChargeResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this V1ChargeResponse.  # noqa: E501

        Charge 对象  # noqa: E501

        :return: The data of this V1ChargeResponse.  # noqa: E501
        :rtype: V1Charge
        """
        return self._data
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this V1ChargeResponse.

        Charge 对象  # noqa: E501

        :param data: The data of this V1ChargeResponse.  # noqa: E501
        :type: V1Charge
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1ChargeResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1ChargeResponse):
            return False
