...
class V1ExtraWechatpayAppConfig(object):
    ...
    def __init__(self, appid=None, noncestr=None, package=None, partnerid=None, prepayid=None, sign=None, timestamp=None, _configuration=None):  # noqa: E501
        """V1ExtraWechatpayAppConfig - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1ExtraWechatpayAppConfig, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1ExtraWechatpayAppConfig):
            return False
