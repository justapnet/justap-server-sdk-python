...
class ChargeRoutingRequestChargeMethod(object):
    ...
    allowed enum values
    """
    CHARGE_METHOD_UNKNOWN = "CHARGE_METHOD_UNKNOWN"
    CREATE_CHARGE = "CREATE_CHARGE"
    QUERY_CHARGE = "QUERY_CHARGE"
    CLOSE_CHARGE = "CLOSE_CHARGE"
    ...
    def __init__(self, _configuration=None):  # noqa: E501
        """ChargeRoutingRequestChargeMethod - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ChargeRoutingRequestChargeMethod, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ChargeRoutingRequestChargeMethod):
            return False
