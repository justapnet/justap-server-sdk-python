...
class V1ExtraAlipayExtUserInfo(object):
    ...
    def __init__(self, cert_no=None, cert_type=None, fix_buyer=None, min_age=None, mobile=None, name=None, need_check_info=None, _configuration=None):  # noqa: E501
        """V1ExtraAlipayExtUserInfo - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1ExtraAlipayExtUserInfo, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1ExtraAlipayExtUserInfo):
            return False
