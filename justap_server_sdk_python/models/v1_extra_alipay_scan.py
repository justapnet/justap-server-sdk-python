...
class V1ExtraAlipayScan(object):
    ...
    def __init__(self, advance_payment_type=None, auth_code=None, auth_confirm_mode=None, auth_no=None, buyer_id=None, buyer_logon_id=None, buyer_pay_amount=None, buyer_user_id=None, discount_amount=None, discount_goods_detail=None, discountable_amount=None, extend_params=None, fund_bill_list=None, gmt_payment=None, goods_detail=None, invoice_amount=None, is_async_pay=None, operator_id=None, pay_params=None, point_amount=None, product_code=None, query_options=None, receipt_amount=None, request_org_pid=None, scene=None, store_id=None, store_name=None, terminal_id=None, total_amount=None, voucher_detail_list=None, _configuration=None):  # noqa: E501
