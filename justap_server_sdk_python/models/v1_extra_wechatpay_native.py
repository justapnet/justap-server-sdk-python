...
class V1ExtraWechatpayNative(object):
    ...
    def __init__(self, attach=None, detail=None, goods_tag=None, qr_code=None, qr_link=None, scene_info=None, settle_info=None, time_expire=None, time_start=None, _configuration=None):  # noqa: E501
        """V1ExtraWechatpayNative - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1ExtraWechatpayNative, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1ExtraWechatpayNative):
            return False
