...
class V1ExtraWechatpayApp(object):
    ...
    """
    swagger_types = {
        'app_config': 'V1ExtraWechatpayAppConfig',
        'attach': 'str',
    ...
    def __init__(self, app_config=None, attach=None, detail=None, goods_tag=None, prepay_id=None, scene_info=None, settle_info=None, time_expire=None, time_start=None, _configuration=None):  # noqa: E501
        """V1ExtraWechatpayApp - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1ExtraWechatpayApp, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1ExtraWechatpayApp):
            return False
