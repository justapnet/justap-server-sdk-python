...
class V1ChargeListResponse(object):
    ...
    @property
    def data(self):
        """Gets the data of this V1ChargeListResponse.  # noqa: E501

        包含一个由请求参数分页后的返回对象实体  # noqa: E501

        :return: The data of this V1ChargeListResponse.  # noqa: E501
        :rtype: list[V1Charge]
        """
        return self._data
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this V1ChargeListResponse.

        包含一个由请求参数分页后的返回对象实体  # noqa: E501

        :param data: The data of this V1ChargeListResponse.  # noqa: E501
        :type: list[V1Charge]
        """
    ...
    @property
    def has_more(self):
        """Gets the has_more of this V1ChargeListResponse.  # noqa: E501

        表明获取列表之后是否还有更多的元素实体。如果值为 false，表明当前页是最后一页  # noqa: E501

        :return: The has_more of this V1ChargeListResponse.  # noqa: E501
        :rtype: bool
        """
    ...
    def has_more(self, has_more):
        """Sets the has_more of this V1ChargeListResponse.
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1ChargeListResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1ChargeListResponse):
            return False
