...
class BusinessUserServiceApi(object):
    ...
    def business_user_service_list_all_users(self, **kwargs):  # noqa: E501
        """查询 BusinessUser 对象列表  # noqa: E501
    ...
    def business_user_service_update_user(self, id, **kwargs):  # noqa: E501
        """更新 BusinessUser 对象  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.business_user_service_update_user(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.business_user_service_update_user_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.business_user_service_update_user_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def business_user_service_update_user_with_http_info(self, id, **kwargs):  # noqa: E501
        """更新 BusinessUser 对象  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.business_user_service_update_user_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['id', 'app_id', 'address', 'currency', 'description', 'email', 'name', 'phone', 'avatar', 'disabled', 'gender', 'parent_user_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('id' not in params or
                                                       params['id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `id` when calling `business_user_service_update_user`")  # noqa: E501
        ...
        if 'parent_user_id' in params:
            query_params.append(('parent_user_id', params['parent_user_id']))  # noqa: E501
